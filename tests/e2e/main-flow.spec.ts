...
test.describe('StampChain E2E', () => {
  ...
  test('stamp card visual renders on landing', async ({ page }) => {
    ...
    await page.screenshot({ path: `${SCREENSHOT_DIR}/02-stamp-card.jpg`, type: 'jpeg', quality: 85 });
  });
  ...
  test('merchant dashboard shows customer list', async ({ page }) => {
    ...
    await page.screenshot({ path: `${SCREENSHOT_DIR}/04-dashboard.jpg`, type: 'jpeg', quality: 85 });
  });
